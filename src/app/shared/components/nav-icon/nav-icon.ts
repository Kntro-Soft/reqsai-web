...
import { lucideFolder, lucideList, lucideMic, lucideSettings, lucideUsers } from '@ng-icons/lucide';
...
@Component({
  ...
  imports: [HlmIcon],
  viewProviders: [
    provideIcons({ lucideFolder, lucideMic, lucideList, lucideUsers, lucideSettings }),
  ],
